<?php
namespace Creditvantiv\Payment\Controller\Index;

use Creditvantiv\Payment\Model\Payment;
...
class Index extends \Magento\Framework\App\Action\Action
{
	...
	public function execute()
	{
        ...
        $creditpayment = $objectManager->create('Creditvantiv\Payment\Model\Payment');
        $creditpaymentadd = $objectManager->create('Creditvantiv\Payment\Model\Payment');
