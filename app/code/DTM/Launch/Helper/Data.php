...
class Data extends AbstractHelper{
	...
	{
		return $this->_scopeConfig->getValue('dtm_launch/adobe/enabled', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
	}
	...
	{
		return true;//return $this->_scopeConfig->getValue("dtm_launch/add_to_cart/enabled");
	}

	public function isAddToWishlistPixelEnabled()
	{
		return true;//return $this->_scopeConfig->getValue('dtm_launch/add_to_wishlist/enabled');
	}

	public function isInitiateCheckoutPixelEnabled()
	{
		return true;//return $this->_scopeConfig->getValue('dtm_launch/inititiate_checkout/enabled');
	}

	public function isViewProductPixelEnabled()
	{
		return $this->_scopeConfig->getValue('dtm_launch/view_product/enabled');
	}

	public function isSearchPixelEnabled()
	{
		return true;//return $this->_scopeConfig->getValue('dtm_launch/search/enabled');
	}

	public function getScript($store)
	{
		return $this->_scopeConfig->getValue("dtm_launch/adobe/url", \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
	}
