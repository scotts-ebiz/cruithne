...
class Vault extends \Vantiv\Payment\Helper\Vault
{
    ...
    /**
     * Checks if vault enabled for KeyPad payment method
     *
     * @return bool
     */
    public function isKeyPadVaultEnabled()
    {
        return $this->isVaultEnabled(VantivKeyPadConfig::VAULT_CODE);
    }
