    ...
    function ($, $t, alert) {
        ...
        $.widget('mage.eprotect', {
            ...
            setResponseData: function (responseData) {
                ...
                $("#payment-vantiv-cc-last-four").val(responseData.lastFour);
                $("#payment-vantiv-cc-exp-month").val(responseData.expMonth);
                $("#payment-vantiv-cc-exp-year").val(responseData.expYear);
            }
        });
