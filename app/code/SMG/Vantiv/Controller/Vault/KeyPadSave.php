 ...
 */
namespace SMG\Vantiv\Controller\Vault;
...
class KeypadSave extends CardsManagement
{
    /**
     * Token manager.
     *
    ...
    public function execute()
    {
         ...
         * Validate request.
         */
        if (!$this->getValidator()->validate($request) || !$this->getVaultHelper()->isKeyPadVaultEnabled()) {
