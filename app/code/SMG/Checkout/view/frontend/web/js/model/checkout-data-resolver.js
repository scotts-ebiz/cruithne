...
define([
    ...
    return {
        ...
        resolveShippingRates: function (ratesData) {
            ...
            if (!availableRate) {
                // CUSTOM: Pick free shipping if available instead of nothing.
                // This assures that free shipping is shown on the cart page when available
                var free = _.find(ratesData, function(item){ return item.method_code === "freeshipping"; });
                if (ratesData && ratesData.length && free) {
                    selectShippingMethodAction(free);
                } else {
