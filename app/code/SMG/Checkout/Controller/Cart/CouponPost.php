            ...
            if ($codeLength) {
                ...
                if (!$itemsCount) {
                    if ($isCodeLengthValid && $coupon->getId()) {
                        // Since this was a successful coupon code then set a flag
                        // to disable error message if it was set
                        ...
                        // Since this was an unsuccessful coupon code then set a flag
                        // to enable error message
                        $this->_checkoutSession->setCouponValid(false);
                    }
                } else {
