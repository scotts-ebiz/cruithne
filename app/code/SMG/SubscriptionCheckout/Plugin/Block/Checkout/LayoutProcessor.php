...
class LayoutProcessor {
    ...
    )
    {
        ...
        $this->_logger->debug('CUSTOM LAYOUT PROCESSOR CONSTRUCTOR');
    }

    public function afterProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $subject, array $result) {
            $this->_logger->debug('CUSTOM LAYOUT PROCESSOR');
            if ( !$this->_subscriptionHelper->isActive($this->_storeManager->getStore()->getId()))
            {
                return;
            }
            $this->_logger->debug('CUSTOM LAYOUT PROCESSOR AFTER IF');

		    if (isset($result['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street'])) {
                $this->_logger->debug('CUSTOM LAYOUT PROCESSOR AFTER ISSET');

            $result['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['firstname']['children']['0']
            ['validation'] = ['required-entry' => false,'required-entry-firstname' => true];

		        $result['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['lastname']['children']['0']
            ['validation'] = ['required-entry' => false,'required-entry-lastname' => true];

		        $result['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street']['children']['1']
            ['validation'] = ['required-entry-lastname' => true];
