...
use SMG\ImageGallery\Catalog\Model\ResourceModel\Product\Image as ProductImage;
use Magento\Theme\Model\Config\Customization as ThemeCustomizationConfig;
use Magento\Theme\Model\ResourceModel\Theme\Collection;
use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\MediaStorage\Helper\File\Storage\Database;
use Magento\MediaStorage\Model\File\Storage\Database as GalleryDatabase;
use Magento\MediaStorage\Model\File\Storage\File as FileDatabase;
...
class ImageResize extends \Magento\MediaStorage\Service\ImageResize
{
    ...
    private function resize(array $viewImage, string $originalImagePath, string $originalImageName)
    {
        ...
        $mediastoragefilename = $this->imageConfig->getMediaPath($originalImageName);
        $originalTemp= $this->mediaDirectory->getAbsolutePath($mediastoragefilename);
