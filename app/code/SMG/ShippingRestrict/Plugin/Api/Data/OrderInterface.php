...
class OrderInterface{
    ...
    if($quote->getShippingAddress()){
        $this->_logger->info('Shipping'); 
        $this->_logger->info($quote->getShippingAddress()->getRegion()); 
        $this->_logger->info('Shippingend'); 
    }
    else
    {
       $this->_logger->info('Billing'); 
       $this->_logger->info($quote->getBillingAddress()->getRegion()); 
       $this->_logger->info('Billingend'); 
    }
