 ...
 */
namespace SMG\Framework\View\Element\Js;
...
class Cookie extends Template
{
     ...
     */
    public function getSessionConfig(): ConfigInterface
    {
     ...
     */
    public function setSessionConfig(ConfigInterface $sessionConfig): void
    {
