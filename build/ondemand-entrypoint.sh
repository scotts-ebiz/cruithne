...
su - magento -c 'sed -i "s/.*mouseEventProps = .*/\tmouseEventProps = 0,/" /var/www/html/magento2/pub/static/frontend/Scottsbase/mygro/en_US/jquery/jquery.mobile.custom.js'
