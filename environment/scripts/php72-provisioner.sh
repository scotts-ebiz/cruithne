...
echo "xdebug.remote_autostart=0" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_enable=1" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_port=9000" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_connect_back=1" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_handler=dbgp" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_host=127.0.0.1" | sudo tee -a /etc/php/7.2/cli/php.ini
echo "xdebug.remote_log = 1" | sudo tee -a /etc/php/7.2/cli/php.ini
