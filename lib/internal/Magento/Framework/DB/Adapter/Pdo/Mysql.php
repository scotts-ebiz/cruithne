        ...
        do {
            ...
            try {
                	...
                	&& in_array($pdoException->errorInfo[1], $deadlockErrors))
                {
                	...
                	$this->_psrLogger->debug("Encountered Deadlock Exception. Retrying in {$sleepSeconds} seconds. Full exception details below. " . $e->getMessage() . "\n" . $e->getTraceAsString());
                	$this->_psrLogger->debug("SQL: " . $sql);
                	sleep(30);
                }
